...
def create_gdp_hero_banner(data_sources):
    ...
    if gdp_metrics:
        ...
        <div style="background: width: 100vw; linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 2rem; border-radius: 30px; margin: 1rem 0; box-shadow: 0 8px 32px rgba(0,0,0,0.1);">
        ...
        """
        components.html(html_code, height=375, width=1800)
